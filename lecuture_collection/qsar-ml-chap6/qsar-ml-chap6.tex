...
\begin{frame}{Hansch Equation: The Mathematical Foundation (1962)}
  \iqblayouttwo{
    ...
    \begin{iqbitemize}
      \item $y$: biological activity (e.g., log(1/C), \ce{pIC50})
...
\begin{frame}{Data Quality: ``Trust, but Verify'' (OECD P1)}
  \iqblayouttwo{
    ...
    \begin{iqbitemize}
      ...
      \item \textbf{Activity range}: Log-scale variation (e.g., \ce{pIC50} 4--10)
...
\begin{frame}{Classification Metrics: Beyond Accuracy}
  \iqblayouttwo{
    ...
    \begin{iqbitemize}
      \item \textbf{Sensitivity} = $\dfrac{\text{TP}}{\text{TP}+\text{FN}}$ (recall)
      \item \textbf{Specificity} = $\dfrac{\text{TN}}{\text{TN}+\text{FP}}$
      \item \textbf{Precision} = $\dfrac{\text{TP}}{\text{TP}+\text{FP}}$
      \item \textbf{F1} = $\dfrac{2 \cdot \text{Prec} \cdot \text{Rec}}{\text{Prec} + \text{Rec}}$
    \end{iqbitemize}
  }{
    ...
    \begin{iqbitemize}
      ...
      \item \textbf{Enrichment Factor} (EF) for screening: \\
            $\text{EF} = \dfrac{\text{\% actives in top 10\%}}{\text{\% actives overall}}$
    \end{iqbitemize}
  }
\end{frame}
...
\begin{frame}{Beyond Activity: QSAR Variants (QSPR, QSRR, QSTR)}
  ...
  \iqblayouttwo{
    ...
    \begin{iqbitemize}
      ...
      \item[QSTR] Toxicity risk; acute \ce{LD50} predictions, carcinogenicity/mutagenicity flags, regulatory QSAR
    \end{iqbitemize}
  }
\end{frame}
