...
\begin{frame}{Historical Background \& Milestones}
  \iqblayouttwo{
    ...
    \iqbgreenbox{Teaching cue}{
      Use timeline questions: 鈥淲hich inflection made QSAR mainstream?鈥?to recap Fig. 6.1 context.
    }
  }
\end{frame}
...
\begin{frame}{QSAR Modeling Workflow (Fig. 6.1 Inspired)}
  \iqblayouttwo{
    ...
    \begin{iqbitemize}
      \item Structure standardization (Fourches et al. 鈥淭rust, but verify鈥?.
...
\begin{frame}{Molecular Descriptors: 1D to 6D}
  ...
  \begin{tabular}{p{0.08\textwidth}p{0.28\textwidth}p{0.52\textwidth}}
    ...
    2D & Topological & Connectivity indices, Kier鈥揌all, fragment counts, logP. Captures adjacency.\\
...
\begin{frame}{QSAR Modeling Platforms \& Software Ecosystem}
  \iqblayouttwo{
    ...
    \begin{iqbitemize}
      ...
      \item Commercial platforms (MOE, Schr枚dinger) when structural modeling is entwined.
    \end{iqbitemize}
  }
\end{frame}
