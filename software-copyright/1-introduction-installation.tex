...
开发者 & IQB Lab 课题组 \\
开发单位 & 浙江大学定量生物中心 (Institute of Quantitative Biology) \\
仓库地址 & \href{https://github.com/gxf1212/IQB-JC-Beamer-Template}{https://github.com/gxf1212/IQB-JC-Beamer-Template} \\
许可证 & MIT License \\
\bottomrule
\end{tabular}
\end{table}
...
项目菜单 $\rightarrow$ Menu $\rightarrow$ Compiler $\rightarrow$ 选择 XeLaTeX

\textbf{TeXStudio}

选项 $\rightarrow$ 配置 TeXStudio $\rightarrow$ Build $\rightarrow$ Default Compiler $\rightarrow$ 选择 XeLaTeX
